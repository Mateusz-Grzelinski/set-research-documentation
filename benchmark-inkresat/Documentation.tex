...
\begin{itemize}
  ...
  \item \mintinline{text}{()p} - p jest spełnione w stanie następnym po stanie odniesienia (następny)
  \item \mintinline{text}{pUq} - p jest spełnione dopóki nie jest spełnione q (dopóki)
