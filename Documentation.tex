...
\textbf{Żywotność} systemu określa zbiór cech, który musi posiadać system, aby działał bez błędu. Reguła żywotna nie może zotać naruszona w żadnym wypadku. Formalnie w \gls{LTL} TODO

\textbf{Bezpieczeństwo} systemu to cecha, która zapewnia, że ''nic złego nigdy się nie stanie''. Reguła bezpieczeństwa może zostać naruszona w czasie działania systemu, choć system nie będzie bezpieczny, gdzie niebezpieczeństwem może być na przykład narażone życie człowieka, nieautoryzowany dostęp do zasobów itp. Formalnie TODO
