...
Generator ma spełnić 2 cele: ma wygenerować formułę CNF z okreżloną ilością klauzul oraz określoną ilością zmiennych.
...
\begin{itemize}
  \item nazwa zmiennej
  \item ilość różnych zmiennych
  \item ilość zmiennych do wygenerowania, ilość różnych zmiennych jest mniejsza lub równa ilości zmiennych
