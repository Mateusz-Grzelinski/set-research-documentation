...
\input{listings/language_definitons.tex}
...
\lstinputlisting[language=ladr,caption={Przykład pliku wejściowego w składni LADR}]{listings/prover9_example.in}
...
\lstinputlisting[language=spass,caption={Przykład pliku wejściowego w składni SPASS}]{listings/spass_example.in}
